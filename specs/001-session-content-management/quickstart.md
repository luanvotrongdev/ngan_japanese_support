...
5. Create and edit a session, then add one entry of each content type.
6. Restart the app and confirm all content remains unchanged.
7. Delete one entry and confirm sibling content remains.
...
- `bun run test:e2e`: passed the session plus vocabulary, kanji, and grammar journey
